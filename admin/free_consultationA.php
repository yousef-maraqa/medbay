	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-4 p-md-5 pt-5">
			...
			<?php
					 ...
					 $result = mysqli_query($link, "SELECT * FROM free_consultation");
				...
				<table class="table table-borderd" id="appoTable" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<?php
							 if (isset($_POST['delete_btn_f'])) {
								$id =$_POST['delete_id'];
								$query="DELETE  FROM free_consultation WHERE id='$id' ";
								$query_run=mysqli_query($link,$query);
								header('location:free_consultationA.php');
							 }
							 ?>
				 ...
				 echo '<h5>'.'Number Of Consultation Messages :   ' .$row_num. '</h5>';

					 }
					 else{
					 $noRecord= "No Consultation Sent";
					 ?>
