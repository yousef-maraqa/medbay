...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    if(empty(trim($_POST["old_password"]))){
        ...
        $result = mysqli_query($link, "SELECT * from doctors WHERE dname='" . $_SESSION["username"] . "'");
    $row = mysqli_fetch_array($result);
    if ($_POST["old_password"] == $row["dpassword"]){
    ...
    if(empty($new_password_err) && empty($confirm_password_err)&&empty($old_password_err)){
        ...
        $sql = "UPDATE doctors SET dpassword = '$new_password' WHERE dname = '" . $_SESSION["username"] . "'";
						...
						<div class="col-xs-12 text-center">
							<div class="menu-1">
								...
								<ul>
                                    ...
                                    <li><a href="consultation.php" titel="My Consultations"><span class="size"><i class="fas fa-notes-medical"></i></span></a></li>
