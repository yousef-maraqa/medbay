...
<body>
	...
	<div id="page">
		...
		<h1 class ="text-center pass_change_mar">My <span class="color">Consultations</span></h1>

		<?php
	$dname = htmlspecialchars($_SESSION["username"]);
	
	$result = mysqli_query($link, "SELECT * FROM free_consultation WHERE doctor='$dname'");
	?>
			...
			<table class="table table-borderd" id="appoTable" width="60%" cellspacing="0">
				...
				while($row= mysqli_fetch_assoc($result)){
					...
					<tr>
							...
							<td><span class="size"><a class="mail" href="mailto:<?php echo $row['email']; ?> 
							?subject=About Your Consultation &body=Hello, <?php echo $row['name']; ?>
							%0D%0AThis is (DR <?php echo $row['doctor']; ?>)"><i class="fas fa-envelope"></i></a></td>
